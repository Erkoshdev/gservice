    ...
    <div class="auth-container registration-container">
      ...
      <div class="auth-container-caption">
        <div class="auth-container-title">
          <router-link class="btn-plain auth-back-link" to="/">
        ...
        <div class="auth-container-form">
          ...
          <app-input
              ...
              type="password"
          ></app-input>
          <app-button type="btn-warning" size="btn-lg" @action="registration">{{ $t('contin') }}</app-button>
          <div class="registration-agreement-text">
            {{ $t('public_offer') }}
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    registration(){
      ...
      API.authApi.registration(this.form).then((res) => {
        if(res.success) {
           this.$router.push('/');
          }
      });
